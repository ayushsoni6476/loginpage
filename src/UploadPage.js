...
class App extends Component {
  ...
  componentDidMount() {
    var currentScreen = [];
    currentScreen.push(
      <UploadScreen appContext={this.props.appContext} role={this.props.role} />
    );
      ...
      <div className="App">
        ...
        <MuiThemeProvider>
          <Drawer open={this.state.draweropen}>
            ...
            <div>
              <MenuItem
                onClick={event => this.handleMenuClick(event, "openprint")}
              >
                Printing Page
              </MenuItem>
              <MenuItem
                onClick={event => this.handleMenuClick(event, "openpast")}
              >
                Past Files
              </MenuItem>
              <MenuItem
                onClick={event => this.handleMenuClick(event, "logout")}
              >
                Logout
              </MenuItem>
            </div>
